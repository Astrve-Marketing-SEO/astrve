...
export default function ServicesPage() {
  return (
    <PageLayout>
            ...
            <div>
              ...
              <h1 className="relative space-y-3">
                ...
                <div className="relative">
                  <span className="text-3xl lg:text-5xl font-medium tracking-tight text-gray-900">Website Design and</span>
                </div>
                <div className="relative">
      ...
      {/* Section 1 - Website Design and Development That Delivers Results */}
      <div className="relative py-24 sm:py-32 bg-gradient-to-b from-white to-indigo-50/30">
        <div className="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl">
          <div className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-indigo-200 to-indigo-100 opacity-10 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"></div>
        </div>
          ...
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <span className="relative inline-block px-2">
                  <span className="relative z-10 bg-gradient-to-r from-indigo-600 to-indigo-500 bg-clip-text text-transparent">Results</span>
                  <div className="absolute -bottom-1 left-0 w-full h-3 bg-indigo-100 -rotate-1"></div>
                </span>
              </h2>
              ...
              <div className="mt-8 flex justify-center">
                <div className="relative max-w-3xl">
                  <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                  <p className="pl-6 text-lg leading-8 text-gray-600 text-left">
                  ...
                  <p className="pl-6 mt-6 text-lg leading-8 text-gray-600 text-left">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {/* Card 1 */}
              <div className="relative overflow-hidden rounded-lg border border-gray-100 bg-white p-8 shadow-sm transition-all duration-200 hover:shadow-md">
                <div className="absolute -right-4 -top-4 w-24 h-24 bg-indigo-50 rounded-full opacity-80"></div>
                <div className="relative">
                  ...
                  <p className="mt-2 text-gray-600">Tailored specifically to your brand identity and business objectives.</p>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-lg border border-gray-100 bg-white p-8 shadow-sm transition-all duration-200 hover:shadow-md">
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-gray-600">Optimized for all devices, ensuring a seamless experience for all visitors.</p>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-lg border border-gray-100 bg-white p-8 shadow-sm transition-all duration-200 hover:shadow-md">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Conversion-Focused</h3>
                  <p className="mt-2 text-gray-600">Strategically designed to turn visitors into leads and customers.</p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <span className="relative ml-2 inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-indigo-600 to-indigo-500 bg-clip-text text-transparent">How We Bring Your Vision to Life</span>
                  <div className="absolute -bottom-1 left-0 w-full h-3 bg-indigo-100 -rotate-1"></div>
                </span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="relative order-2 lg:order-1">
                <div className="absolute -left-4 top-1/2 w-72 h-72 bg-indigo-100 rounded-full blur-3xl opacity-70 -z-10"></div>
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -right-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">01</div>
                </div>
              </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Discovery and Planning</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Design and Wireframing</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -left-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">02</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="relative order-2 lg:order-1">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -right-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">03</div>
                </div>
              </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Content and Messaging</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Development and Integration</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -left-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">04</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="relative order-2 lg:order-1">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -right-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">05</div>
                </div>
              </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Testing and Launch</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Ongoing Support and Growth</h3>
                  <div className="relative">
                    <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-indigo-500 to-transparent opacity-20"></div>
                    <p className="pl-6 text-lg leading-8 text-gray-600">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="absolute -bottom-3 -left-3 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xl">06</div>
                </div>
              </div>
            </div>
      ...
      <div className="py-24 sm:py-32 bg-gradient-to-b from-white to-indigo-50/40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 transition-all duration-200 hover:shadow-md">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-100 text-indigo-600 mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Custom, On-Brand Design</h3>
              <p className="text-gray-600">No cookie-cutter templates here. We tailor every pixel to match your brand's voice and style.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 transition-all duration-200 hover:shadow-md">
              ...
              <p className="text-gray-600">Expect a seamless experience on desktops, tablets, and smartphones, so you never miss out on potential customers.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 transition-all duration-200 hover:shadow-md">
              ...
              <p className="text-gray-600">Need new features down the road? Our flexible frameworks let us adapt to your evolving needs.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 transition-all duration-200 hover:shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Easy Content Management</h3>
              <p className="text-gray-600">Want to add a blog post or update a product description? We'll set you up with a user-friendly CMS so you can make changes anytime - or use our SEO services to automate this.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 transition-all duration-200 hover:shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Built-In SEO Foundations</h3>
              <p className="text-gray-600">We follow best practices for search engine rankings, giving your site a boost from the get-go.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="calendly" className="py-24 sm:py-32 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="text-3xl font-medium tracking-tight text-white sm:text-4xl">
              Portfolio
              <span className="block text-indigo-400 mt-1">Looking for Samples?</span>
            </h2>
          ...
          <div className="mt-12 text-center">
            <Link 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-indigo-600 to-indigo-500 text-white font-medium hover:from-indigo-500 hover:to-indigo-400 transition-all duration-200"
            >
